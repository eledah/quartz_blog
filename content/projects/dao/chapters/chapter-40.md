...
اصل کار جملهٔ آخر است که «نیستی» زایندهٔ «هستی» است. در [[chapter-11|فصل ۱۱]] صحبت مشابهی شده است. هستی در فضای نیستی امکان پیدا می‌کند. متن [[in-praise-of-whats-not||در ستایش آنچه نیست]] را هم با الهام از همین فصل نوشته‌ام.
