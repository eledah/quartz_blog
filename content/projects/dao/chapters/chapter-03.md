...
جلوتر در [[chapter-27|فصل ۲۷]] می‌بینیم که «انسان نانیک، سرمایهٔ انسان نیک است». یعنی به جای مذمت، فرصتی هست برای شخص فرزانه که این سرمایهٔ خودش را در اختیار دیگری بگذارد. برتر دانستن یکی و سرکوب دیگری این نظم را به هم می‌زند و باعث غلیان فرودست می‌شود.

نکتهٔ جالب دیگر سست کردن آرزوهاست. یا به بیان دیگر تضعیف جاه‌طلبی. حاکم باید با افراد سیّاس، حیله‌گر و دسیسه‌چین برخورد کند؛ چرا که انگار درست خلاف جریان طبیعی و [[4-wuwei|Wu Wei]] رفتار می‌کنند. اگر انسان را استعاره‌ای از جامعه بگیریم، ساکت کردن دسیسه‌چین‌ها مشابه ساکت کردن وسوسه‌های درونی است که انسان را به صد جهت می‌کشاند. همانطور که انسان با سکوت و چیزی نخواستن میل واقعی خودش را کشف می‌کند ([[chapter-01|فصل ۱]])، جامعه هم اگر چیزی نخواهد ([[chapter-12|فصل ۱۲]]) و با مقایسهٔ دائم جاه‌طلبی نکند، می‌فهمد که چه می‌خواهد و در مسیر می‌افتد.
