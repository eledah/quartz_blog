...
اصل تعریف «یین» اینجاست: «مادینهٔ رازآلود» یا «زن اسرارآمیز» مادر همه‌چیز است و همه‌چیز از آن به وجود آمده. برای فهمیدنش می‌شود به رابطهٔ کوه و دره نگاه کرد. کوه با اینکه ارتفاع می‌گیرد، اما سرزندگی ندارد. سرد و غیرقابل سکونت است. اما به خاطر رودهایی جاری آن دره‌ای شکل می‌گیرد که با جذب منابع، زندگی می‌سازد. پذیرش دره، به آن قوت خلق می‌دهد. سرسختی کوه، حق بخشش حیات را از آن می‌گیرد.
