...
اصل فصل جملهٔ آخرش است: «دائو از خودانگیختگی خویش الگو می‌گیرد» یا «راه به دنبال آن‌چه هست می‌رود» یا «دائو از آنچه هست، پیروی می‌کند». پس علتی ندارد. یا خودش علت خودش است(؟) عبارت Ziran 自然 برای فلسفهٔ غرب که به قول نیچه مدام دنبال «علت‌العلل» می‌گردد[^1]، دور از ذهن و غیرمنطقی است. اما خیلی راحت در اینجا و در کتاب چوانگ‌زو -داستان سازهای بهشت یا Pipes of Heaven- زیرآب آن زده می‌شود. فراموش نکنیم که در [[chapter-11|فصل ۱۱]] پایهٔ دائو بر اساس خلأ و نیستی است که موجودات از قبل آن شکل گرفته‌اند.
...
[^1]: اصطلاحاً به آن Ursachentrieb یا Causality Drive یا عقدهٔ علت‌جویی می‌گویند. همچنین ر.ک. [[peach-and-onion|هلو و پیاز]]
