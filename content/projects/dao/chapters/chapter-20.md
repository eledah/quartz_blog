...
استعارهٔ نوزاد ([[chapter-10|فصل ۱۰]]) اینجا کامل‌تر می‌شود. نوزاد مستقیم به مادر -دائو- متصل است و کاری با دنیا ندارد. پاسخ‌ها را نمی‌داند و مثل مردم عادی هدف خاصی ندارد که بخواهد به دنبال آن بیفتد.
