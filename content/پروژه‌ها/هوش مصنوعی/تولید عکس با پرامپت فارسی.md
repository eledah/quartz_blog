...
در این متن روندی مرتب و منظم برای ساختن تصویر از پرامپت زبان فارسی ارائه می‌شود. پیش‌نیاز این بحث، [[مدل‌سازی و چهره‌پردازی با Flux|ساختن مدلی اولیه با Flux]] است.
...
حالا که پرامپت انگلیسی آماده شده است، در این گام مشابه آنچه در ضمیمهٔ متن [[مدل‌سازی و چهره‌پردازی با Flux#ضمیمه ۲ بهینه‌سازی برای کاربران عادی|مدل‌سازی با Flux]] گفتیم، پرامپت را برای سرور Replicate ارسال می‌کنیم تا تصویر را برای ما بسازد.
‍‍‍
