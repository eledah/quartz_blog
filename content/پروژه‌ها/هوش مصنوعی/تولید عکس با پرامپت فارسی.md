...
در این متن روندی مرتب و منظم برای ساختن تصویر از پرامپت زبان فارسی ارائه می‌شود. پیش‌نیاز این بحث، [[مدل‌سازی و چهره‌پردازی با Flux|ساختن مدلی اولی با Flux]] است.
