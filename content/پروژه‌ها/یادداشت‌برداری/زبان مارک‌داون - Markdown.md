...
برای اضافه کردن پانوشت کافیست ابتدا در متن مبدأ آن را مشخص کنید و سپس به این شکل عدد بزنید: ‍`[^4]`. عدد ۴ در اینجا به معنی پانوشت چهارم متن است. در مرحلهٔ بعدی به انتهای مطلب بروید و به این شکل[^4] توضیحات لازم را برای پانوشت بنویسید:
...
استفاده از `iframe` کیفیت یادداشت‌ها را یک مرحله بالاتر می‌برد. شما می‌توانید ویدئوهای یوتیوب و آپارات، مقاله‌های اینترنتی، تقویم گوگل، توییت و هر اطلاعات آنلاین دیگری را بدون نیاز به مرورگر در نرم‌افزار داشته باشید.
...
[^3]: این قابلیت هنوز به طور کامل به برنامهٔ سایت اضافه نشده است و اینجا به درستی نمایش داده نمی‌شود. لذا شما تصور کنید که اینجا جدول ابتدای متن فراخوانی شده است.
[^4]: توضیحات پانوشت چهارم
