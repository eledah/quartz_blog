...
date: 2026-03-14
cssclasses:
image: /attachment/room_412.jpeg
featured: true
order: 3
description: داستان کوتاه
---
آفتابِ بعدازظهر با سماجت از شیشه‌های قدیِ لابی هتل به داخل می‌تابید. آسمان طوری تمیز بود که گویا همهٔ ابرها مرخصی بودند. لیلا چمدان نقره‌ای‌اش را رها کرد و نفس عمیقی کشید. بوی قهوهٔ تازه و عطرِ تندِ گل‌های روی میز پذیرش، توی هم پیچیده بود. سامان هدفونِ سفیدش را از دورِ گردنش برداشت، آن را در جیب کتش چپاند، کارتِ اتاق را از متصدی گرفت، چشمکی به لیلا زد و گفت: «طبقهٔ چهار. اتاق ۴۱۲.»
...
سامان دست او را کشید. در تاریکی سکندری خوردند. قلب لیلا با شدت به قفسهٔ سینه‌اش می‌کوبید؛ بوم... بوم... صدای ضربانش آن‌قدر بلند بود که توی فضای راهرو اکو می‌شد. سامان کارت را روی سنسور کشید، در را با شتاب باز کرد و هر دو به داخل پرت شدند. در با صدای خشکی پشت سرشان بسته شد.
...
سامان گردنش را برگرداند به سمت پنجره. چشم‌هایش را بست. سرش را به پشتیِ مبل تکیه داد و دیگر هیچی نگفت. پیرمرد هم پلک‌هایش را روی هم گذاشت. صدای بوم... بومِ اتاق حالا آن‌قدر بلند شده بود که پردهٔ گوش لیلا را می‌لرزاند. دیوارِ قرمز و مواجِ اتاق، داشت با هر ضربان، یک سانتیمتر جلوتر می‌آمد تا آن‌ها را برای همیشه در خودش ببلعد. تاریکیِ خفه‌کننده و گرم، داشت پیروز می‌شد.
...
سامان به پیرمرد نگاه کرد، بعد به لیلا، و در نهایت به صفحه‌ی روشنِ گوشی که حالا داشت خاموش می‌شد. لیلا با شستش روی صفحه زد تا روشن بماند. نور، مستقیماً به چشم‌های سامان می‌تابید. نفسِ سامان تند شد. مثل اینکه داشت از زیرِ یک خروار خاک بیرون می‌آمد. سینه‌اش بالا و پایین رفت و بالاخره، با صدایی که شبیهِ پاره شدنِ یک پارچهٔ کهنه بود، سرفه‌ای کرد.
...
لیلا اما مسیرش را کج کرد. رو به پنجرهٔ قدی. رو به آن حجمِ عظیمِ مه که مثل دیواری بتنی پشت شیشه ایستاده بود. لیلا با شانه‌اش به دستگیرهٔ درِ بالکن کوبید. درِ شیشه‌ای که به دیوار جوش خورده بود، با صدای خُرد شدن، باز شد. 
