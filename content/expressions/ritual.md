...
بدون آیین، انسان لنگرگاهی ندارد؛ نمی‌داند کجای زمان ایستاده و قرار است به کجا برود. بدون آیین، زمینِ زمان غیرقابل سکونت خواهد بود. ریتم زندگی را آیین‌های آن تعیین می‌کنند. برای همین است که سنت‌ها پر از آیین‌های مختلف منظم و غیرمنظم هستند؛ حتی سکولارهای منقطع از دین و سنت هم آیین‌های خاص خودشان را دارند[^2]. آیین‌های مهم نقطهٔ عطف زندگی هستند و در آن‌ها مسیر زندگی به کلی عوض می‌شود. برای همین بخش قابل توجهی از زندگی عده‌ای آماده شدن برای همین آیین‌هاست.
