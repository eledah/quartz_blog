...
هر نوع اطلاعات از نظر مکانی، یا **مکان‌مند** است (در مکان‌های خاصی صدق می‌کنند) یا **فرامکان** (همه‌جا). از نظر زمانی هم یا **زمان‌مند** است (در زمان خاصی صدق می‌کنند) یا **فرازمان** (در همهٔ زمان‌ها صدق می‌کنند). هر چقدر گزاره‌ای در حالت‌ها، زمان‌ها و مکان‌های بیشتری صادق باشد، ارزش بیشتری هم دارد. با ترکیب این دو شرط، اطلاعات ورودی ما به چهار قسمت تقسیم می‌شوند:
...
2. مکان‌مند و فرازمان: حرف‌هایی که بر پایهٔ تاریخ، حس و حال کلی یک مکان، قوم یا نژاد را توصیف می‌کنند. خیلی از این حرف‌ها از استعارهٔ **ژن** استفاده می‌کنند: ژن ایرانی، ژن آسیایی یا ژن شرقی.
3. فرامکان و زمان‌مند: حرف‌هایی از جنس تحلیل **روح زمانه**. تحلیل‌های اقتصاد سیاسی یا تحلیل‌های تکنولوژیکی از این جنس هستند. این گزاره‌ها حال فعلی دنیا یا کشور یا سازمان را توصیف می‌کنند.
4. فرامکان و فرازمان: حرف‌هایی که مثل **طلا** همیشه و همه‌جا باارزشند. عمدتاً دربارهٔ ذات تغییرناپذیر اشیاء صحبت می‌کنند.
...
علاوه بر کتب شعر و نثر قدیمی، کتاب‌های مقدس هم پر از جملات فرازمان و فرامکان هستند. مثلاً قرآن در آیهٔ ۱۸۶ سورهٔ آل عمران به مسلمانان می‌گوید که قرار است مدام متلک و حرف آزاردهنده بشنوند و بهترین کار در برابر این آزمایش، صبر است.
...
در کنار شنیدن صحبت دیگران، خود ما هم می‌توانیم به گزاره‌های فرازمان و فرامکان برسیم. مثلاً قضیهٔ زوایای مثلث نشان داد که در هر مرحله با حل کردن حالت کلی‌تری از مسأله، دانش بیشتری کشف می‌شود. اگر برای یک مثلث قضیه درست بود، شاید برای دو مثلث هم جواب دهد. اگر برای دو مثلث هم صادق بود، شاید برای همهٔ مثلث‌ها بشود این کار را کرد. و الی آخر. طراحی ذهن انسان به گونه‌ای است که مدام به دنبال اتفاقات **تکراری و مشابه** می‌گردد تا از بین آن‌ها، به قواعد کلی‌تری برسد. پس وقت گذاشتن برای جمع‌آوری این اتفاقات و کشف الگوی پشت آن‌ها، یکی از راه‌های رسیدن به گزاره‌های ارزشمندتر است.
...
<iframe width="100%" height="520px" src="https://raw.githack.com/eledah/quartz_blog/refs/heads/v4/content/attachment/before-after-slider.html"></iframe>
