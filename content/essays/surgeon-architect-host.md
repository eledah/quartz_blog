...
دیزاینر بر اساس تصورش از مخاطب مسأله را حل می‌کند. فرآیند دیزاین تحت تأثیر این است پرسش است که «آیا افراد «مانع» حل مسائل هستند یا اینکه می‌توانند «خالق» راه‌حل باشند؟». حتی در لایه‌های فردی هم جنس رابطه‌ای که انسان با [[the-bus-metaphor|نیروهای درونی]] خود برقرار می‌کند، در روزمره‌اش مؤثر است. این متن با هدف معرفی سه نگاه **«جراح»، «معمار» و «میزبان»** نوشته شده که حاصل تجربهٔ شخصی من در مشاهدهٔ خروجی‌های مختلف دیزاین و شناسایی جوهرهٔ آن‌هاست. هر کدام از این‌سه، پیش‌فرض‌ها، رفتارها و نتایج خاص خودشان دارند و مسائل خاص خودشان را حل می‌کنند. فایدهٔ شناخت هر یک در زمان مواجهه با مسألهٔ جدید خودش را نشان می‌دهد. به طور خلاصه، نگاه «جراح» به دنبال انسان بیهوش است تا بدون کوچک‌ترین دخالتی کار خودش را بکند، نگاه «معمار» هدفش طراحی زمین بازی و هدایت انسان‌ها به سمت مطلوبات خودش است و نگاه «میزبان» به دنبال فعال‌سازی افراد برای خلق و رساندن آن‌ها به هدفی جوشیده از درون خودشان است.

این متن بر خلاف نوشته‌های قبلی دیزاین، بیشتر بر [[evolution of design|لایه‌های کلان]] (مثل طراحی سیستم، خدمات، رویداد و سیاست‌گذاری) متمرکز است؛ هرچند که این سه لنز به راحتی تا مقیاس‌های خردتر مثل طراحی رابط کاربری یا گرافیک نیز قابل تعمیم هستند. در زیر تلاش می‌کنم هر یک از این استعاره‌ها و نگاه‌ها را بیشتر باز و دربارهٔ کارکرد و محدودیت هرکدام صحبت کنم. 
