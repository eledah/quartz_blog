...
function iconPath(slug2) {
  return joinSegments(pathToRoot(slug2), "static/icon-header.png");
}
...
var PageTitle = ({ fileData, cfg, displayClass }) => {
  ...
  const slug2 = fileData.slug === "404" ? "index" : fileData.slug;
  const baseDir = pathToRoot(slug2);
  const homeHref = baseDir === "." ? "/" : baseDir;
  return /* @__PURE__ */ u2("div", { class: "page-title-container", children: /* @__PURE__ */ u2("h1", { class: classNames(displayClass, "page-title"), children: /* @__PURE__ */ u2("div", { class: "title-logo", children: [
    /* @__PURE__ */ u2("a", { href: homeHref, children: /* @__PURE__ */ u2("img", { id: "icon-header", src: iconPath(slug2), alt: "" }) }),
    /* @__PURE__ */ u2("a", { href: homeHref, class: displayClass, id: "header-text", children: title })
  ] }) }) });
};
PageTitle.css = `
...
export { Footer_default as Footer, PageTitle_default as PageTitle };
